...
export class GeoscapeServicesService {
  geoscapeServices = [
    {
  ...
  getGeoscapeServices() {
    return this.geoscapeServices;
  }

  getGeoscapeServicesById(id: number) {
    return this.geoscapeServices.find((service) => service.id === id);
  }
